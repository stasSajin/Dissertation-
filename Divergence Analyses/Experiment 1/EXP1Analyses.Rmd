...
Put the data in long-format and filter so that only the experimental trials are shown
```{r}
...
CleanDataSubset<-CleanData %>% filter(time>=3100 & time <=4000)

#change the tiem variable so that it starts at 0.
CleanDataSubset$time<-CleanDataSubset$time-3100
