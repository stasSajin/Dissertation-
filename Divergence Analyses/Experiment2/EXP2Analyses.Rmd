...
CleanDataSubset<-CleanData %>% filter(time>=3500 & time <=4800)

#change the tiem variable so that it starts at 0.
CleanDataSubset$time<-CleanDataSubset$time-3500
...
png(filename="TargetVsComExp1.png",width=900,height=524)
...
png(filename="CompvsDistractorExp1.png",width=900,height=524)
grid.arrange(tstat, distribution, nrow=1, ncol=2)
dev.off()
